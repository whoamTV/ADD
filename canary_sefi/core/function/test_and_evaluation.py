...
def adv_trans_generate(trans_list, trans_config, model_config=None, img_proc_config=None, use_raw_nparray_data=False):
    # 标记当前步骤
    ...
    for atk_name in trans_list:
        for trans_name in trans_list[atk_name]:
            for base_model in trans_list[atk_name][trans_name]:
                ...
                attack_log = find_attack_log_by_name_and_base_model(atk_name, base_model)
                adv_trans_4_img_batch(trans_name=trans_name, trans_args=trans_args, atk_log=attack_log, model_name=base_model,
                                      model_args=model_config, img_proc_args=img_proc_config,
                                      use_raw_nparray_data=use_raw_nparray_data)
