...
@sefi_component.trans_class(trans_name="random_jpeg")
@sefi_component.config_params_handler(handler_target=ComponentType.TRANS, name="random_jpeg",
...
class Transform():
    ...
    @sefi_component.trans(name="random_jpeg", is_inclass=True)
